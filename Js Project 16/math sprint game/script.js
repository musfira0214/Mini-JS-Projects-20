...
function playAgain(){
  gamePage.addEventListener('click',startTime);
...
function startTime(){
  ...
  gamePage.removeEventListener('click',startTime)
}
...
start.addEventListener('click', selectQuestionAmount);
gamePage.addEventListener('click',startTime)
// on  load
getSavedBestScores